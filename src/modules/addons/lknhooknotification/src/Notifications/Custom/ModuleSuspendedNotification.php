...
/**
 * Code: ModuleSuspended
 *
 * Instant notification: fires directly off WHMCS's AfterModuleSuspend hook,
 * right after a product/service is suspended.
 *
 ...
 *
 * @see https://developers.whmcs.com/hooks-reference/module/#aftermodulesuspend
 */
...
final class ModuleSuspendedNotification extends AbstractNotification implements ResendableNotificationInterface
{
     ...
     * fires AfterModuleSuspend more than once for it.
     */
    private const SENT_TABLE = 'mod_ishost_module_suspended_sent';
