...
final class DatabaseSetup
{
    public static function activate(): array
    {
        ...
        try {
            ...
            $statement = $pdo->prepare(
                'CREATE TABLE IF NOT EXISTS `mod_dct_hook_notification_reports` (
                    ...
                    CONSTRAINT `fk_queue_id` FOREIGN KEY (`queue_id`) REFERENCES `mod_dct_hook_notification_notif_queue` (`id`) ON DELETE SET NULL
            ...
            $statement = $pdo->prepare(
                'CREATE TABLE IF NOT EXISTS mod_dct_hook_notification_configs (
