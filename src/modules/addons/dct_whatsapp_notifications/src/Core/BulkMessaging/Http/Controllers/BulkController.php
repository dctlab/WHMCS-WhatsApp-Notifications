...
namespace Dct\HookNotification\Core\BulkMessaging\Http\Controllers;

use DateTime;
use Dct\HookNotification\Core\BulkMessaging\Application\Services\BulkService;
use Dct\HookNotification\Core\BulkMessaging\Domain\BulkNotification;
use Dct\HookNotification\Core\BulkMessaging\Domain\BulkStatus;
use Dct\HookNotification\Core\BulkMessaging\Domain\ClientProductStatus;
use Dct\HookNotification\Core\BulkMessaging\Http\NewBulkRequest;
use Dct\HookNotification\Core\Notification\Application\Services\NotificationViewService;
use Dct\HookNotification\Core\Notification\Domain\NotificationTemplate;
use Dct\HookNotification\Core\Platforms\Common\Application\PlatformService;
        ...
        if (isset($request['create-bulk'])) {
            if (empty($clientOptions)) {
                ...
                if ($result->code === 'success') {
                    header("Location: addonmodules.php?module=dct_whatsapp_notifications&page=bulks/{$result->data['bulk_id']}");
