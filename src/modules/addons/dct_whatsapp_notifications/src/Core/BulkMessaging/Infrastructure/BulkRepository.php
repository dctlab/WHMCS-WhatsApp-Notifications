...
namespace Dct\HookNotification\Core\BulkMessaging\Infrastructure;
...
final class BulkRepository extends BaseRepository
{
    ...
    {
        $result = $this->query
                ->table('mod_dct_hook_notification_bulks')
    ...
    public function updateBulk(
        ...
        $query = $this->query->table('mod_dct_hook_notification_bulks')->where('id', $bulkId);
