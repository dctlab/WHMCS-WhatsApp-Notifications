    ...
    <div class="row">
        <div class="col-md-12">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-2">
                                ...
                                <a
                                    ...
                                    href="?module=dct_whatsapp_notifications&page=notification-conversations"
                                >
            ...
            <div>
                ...
                {assign "page_link_tpl" value="?module=dct_whatsapp_notifications&page=notification-conversations`$filters_qs`&pageN"}
