...
/**
 * Code: ProductTermination
 *
 * Instant notification: fires directly off WHMCS's AfterModuleTerminate
 * hook, right after a product/service is terminated.
 *
 ...
 *
 * @see https://developers.whmcs.com/hooks-reference/module/#aftermoduleterminate
 */
...
final class ProductTerminationNotification extends AbstractNotification implements ResendableNotificationInterface
{
     ...
     * fires AfterModuleTerminate more than once for it.
     */
    private const SENT_TABLE = 'mod_ishost_product_termination_sent';
